...
<script type="text/javascript">
    var b=new Array("520481.613517", "1120423.291089", "602893.417982", "1213258.164820");
    var b0=b[0];
    var b1=b[1];
    var b2=b[2];
    var b3=b[3];
    ...
    var $str0=serverOSGeo4W+'healthgismap/Rubella/DongThap/DongThap.map';
    var $str1=serverOSGeo4W+'healthgismap/Rubella/DongThap/DTcopy.map';

	
</script>
<script src="../OpenLayers/OpenLayers.js"></script>
<script src="DTcopy.js"></script>
<script src="DongThap.js"></script>
<script type="text/javascript">
    function getAjax()
    {
        var xmlhttp=null;
