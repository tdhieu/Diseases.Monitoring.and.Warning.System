...
<script type="text/javascript">
    var b=new Array("102.150048", "4.984868", "116.971026", "23.390595");
    var b0=b[0];
    var b1=b[1];
    var b2=b[2];
    var b3=b[3];
    ...
    var str0=serverOSGeo4W+'healthgismap/Rubella/4khuvucVN/4khuvucVN.map';
    var str1=serverOSGeo4W+'healthgismap/Rubella/4khuvucVN/4kvcopy.map';

	</script>
<script src="../OpenLayers/OpenLayers.js"></script>
<script src="4kvcopy.js"></script>
<script src="4khuvucVN.js"></script>
<script type="text/javascript">
    function getAjax()
    {
        var xmlhttp=null;
