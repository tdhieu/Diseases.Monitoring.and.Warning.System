...
<script type="text/javascript">
    var b=new Array("588085.753433", "1212198.170579", "662536.871389", "1302507.888298");
    var b0=b[0];
    var b1=b[1];
    var b2=b[2];
    var b3=b[3];
    ...
    var $str0=serverOSGeo4W+'healthgismap/Rubella/TayNinh/TayNinh.map';
    var $str1=serverOSGeo4W+'healthgismap/Rubella/TayNinh/TNcopy.map';

	
</script>
<script src="../OpenLayers/OpenLayers.js"></script>
<script src="TNcopy.js"></script>
<script src="TayNinh.js"></script>
<script type="text/javascript">
    function getAjax()
    {
        var xmlhttp=null;
