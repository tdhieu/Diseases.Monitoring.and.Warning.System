...
<script type="text/javascript">
    var b=new Array("704079.674081", "1141681.694003", "782428.149114", "1195559.987233");
    var b0=b[0];
    var b1=b[1];
    var b2=b[2];
    var b3=b[3];
    ...
    var $str0=serverOSGeo4W+'healthgismap/Rubella/BRVT/BRVT.map';
    var $str1=serverOSGeo4W+'healthgismap/Rubella/BRVT/BRVTcopy.map';

	
</script>
<script src="../OpenLayers/OpenLayers.js"></script>
<script src="BRVTcopy.js"></script>
<script src="BRVT.js"></script>
<script type="text/javascript">
    function getAjax()
    {
        var xmlhttp=null;
