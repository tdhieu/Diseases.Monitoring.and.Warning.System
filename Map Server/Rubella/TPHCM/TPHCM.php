...
<script src="http://maps.google.com/maps?file=api&amp;v=2&amp;sensor=true_or_false&amp;key=ABQIAAAAoQfdz7x3X9HSGGH6Sm8ZJxT2yXp_ZAY8_ufC3CFXhHIE1NvwkxTEqx6xcQsormKqf9qi7AeAgs_Fuw">    </script>
<?php
...
<script type="text/javascript">
    var b=new Array("106.354850", "10.353551", "107.025759", "11.161245");
    var b0=b[0];
    var b1=b[1];
    var b2=b[2];
    var b3=b[3];
    ...
    var $str0=serverOSGeo4W+'healthgismap/Rubella/TPHCM/TPHCM.map';
    var $str1=serverOSGeo4W+'healthgismap/Rubella/TPHCM/HCMcopy.map';

	
</script>
<script src="../OpenLayers/OpenLayers.js"></script>
<script src="TPcopy.js"></script>	
...
<script type="text/javascript">
    ...
    function draw()
    {
        ...
        xmlhttp = getAjax();
        xmlhttp.open("GET","../total/ajax.php?do=3&tenhuyen=" +tenhuyen,true);
        xmlhttp.send();
