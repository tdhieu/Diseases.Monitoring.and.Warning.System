...
<script type="text/javascript">
    var b=new Array("604304.224220", "1052372.402650", "674244.923067", "1114822.121191");
    var b0=b[0];
    var b1=b[1];
    var b2=b[2];
    var b3=b[3];
    ...
    var $str0=serverOSGeo4W+'healthgismap/Rubella/TraVinh/TraVinh.map';
    var $str1=serverOSGeo4W+'healthgismap/Rubella/TraVinh/TVcopy.map';

	
</script>
<script src="../OpenLayers/OpenLayers.js"></script>
<script src="TVcopy.js"></script>
<script src="TraVinh.js"></script>
<script type="text/javascript">
    function getAjax()
    {
        var xmlhttp=null;
