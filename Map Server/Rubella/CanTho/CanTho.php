...
<script type="text/javascript">
    var b=new Array("524590.460009", "1096652.769510", "592403.335227", "1141534.623939");
    var b0=b[0];
    var b1=b[1];
    var b2=b[2];
    var b3=b[3];
    ...
    var $str0=serverOSGeo4W+'healthgismap/Rubella/CanTho/CanTho.map';
    var $str1=serverOSGeo4W+'healthgismap/Rubella/CanTho/CTcopy.map';

	
</script>
<script src="../OpenLayers/OpenLayers.js"></script>
<script src="CTcopy.js"></script>
<script src="CanTho.js"></script>
<script type="text/javascript">
    function getAjax()
    {
        var xmlhttp=null;
