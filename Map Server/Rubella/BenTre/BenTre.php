...
<script type="text/javascript">
    var b=new Array("612400.060116", "1084137.776901", "696033.469921", "1143486.116718");
    var b0=b[0];
    var b1=b[1];
    var b2=b[2];
    var b3=b[3];
    ...
    var $str0=serverOSGeo4W+'healthgismap/Rubella/BenTre/BenTre.map';
    var $str1=serverOSGeo4W+'healthgismap/Rubella/BenTre/BTcopy.map';

	
</script>
<script src="../OpenLayers/OpenLayers.js"></script>
<script src="BTcopy.js"></script>
<script src="BenTre.js"></script>
<script type="text/javascript">
    function getAjax()
    {
        var xmlhttp=null;
