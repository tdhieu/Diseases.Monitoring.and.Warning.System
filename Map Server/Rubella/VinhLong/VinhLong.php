...
<script type="text/javascript">
    var b=new Array("574617.040835","1092706.222818", "641132.547895", "1142314.195259");
    var b0=b[0];
    var b1=b[1];
    var b2=b[2];
    var b3=b[3];
    ...
    var $str0=serverOSGeo4W+'healthgismap/Rubella/VinhLong/VinhLong.map';
    var $str1=serverOSGeo4W+'healthgismap/Rubella/VinhLong/VLcopy.map';

	
</script>
<script src="../OpenLayers/OpenLayers.js"></script>
<script src="VLcopy.js"></script>
<script src="VinhLong.js"></script>
<script type="text/javascript">
    function getAjax()
    {
        var xmlhttp=null;
