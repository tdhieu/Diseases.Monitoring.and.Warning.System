...
<script type="text/javascript">
    var b=new Array("653474.251478", "1250131.179425", "764260.822503", "1360589.605933");
    var b0=b[0];
    var b1=b[1];
    var b2=b[2];
    var b3=b[3];
    ...
    var $str0=serverOSGeo4W+'healthgismap/Rubella/BinhPhuoc/BinhPhuoc.map';
    var $str1=serverOSGeo4W+'healthgismap/Rubella/BinhPhuoc/BPcopy.map';

	
</script>
<script src="../OpenLayers/OpenLayers.js"></script>
<script src="BPcopy.js"></script>
<script src="BinhPhuoc.js"></script>
<script type="text/javascript">
    function getAjax()
    {
        var xmlhttp=null;
