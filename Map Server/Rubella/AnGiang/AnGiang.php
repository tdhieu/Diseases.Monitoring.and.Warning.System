...
<script type="text/javascript">
    var b=new Array("475469.479033", "1125879.650463", "562802.840403", "1212017.777298");
    var b0=b[0];
    var b1=b[1];
    var b2=b[2];
    var b3=b[3];
    ...
    var str0=serverOSGeo4W+'healthgismap/Rubella/AnGiang/AnGiang.map';
    var str1=serverOSGeo4W+'healthgismap/Rubella/AnGiang/AGcopy.map';
</script>
<script src="../OpenLayers/OpenLayers.js"></script>
<script src="AGcopy.js"></script>
<script src="AnGiang.js"></script>
<script type="text/javascript">
    function getAjax()
    {
        var xmlhttp=null;
