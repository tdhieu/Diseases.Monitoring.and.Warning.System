...
<script type="text/javascript">
    var b=new Array("554243.530336", "1149582.555806", "691130.804245", "1219736.926087");
    var b0=b[0];
    var b1=b[1];
    var b2=b[2];
    var b3=b[3];
    ...
    var $str0=serverOSGeo4W+'healthgismap/Rubella/LongAn/LongAn.map';
    var $str1=serverOSGeo4W+'healthgismap/Rubella/LongAn/LAcopy.map';

	
</script>
<script src="../OpenLayers/OpenLayers.js"></script>
<script src="LAcopy.js"></script>
<script src="LongAn.js"></script>
<script type="text/javascript">
    function getAjax()
    {
        var xmlhttp=null;
