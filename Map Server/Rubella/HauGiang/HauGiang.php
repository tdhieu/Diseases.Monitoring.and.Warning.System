...
<script type="text/javascript">
    var b=new Array("535773.812123", "1059373.017695", "598096.002262", "1104922.766176");
    var b0=b[0];
    var b1=b[1];
    var b2=b[2];
    var b3=b[3];
    ...
    var $str0=serverOSGeo4W+'healthgismap/Rubella/HauGiang/HauGiang.map';
    var $str1=serverOSGeo4W+'healthgismap/Rubella/HauGiang/HGcopy.map';

	
</script>
<script src="../OpenLayers/OpenLayers.js"></script>
<script src="HGcopy.js"></script>
<script src="HauGiang.js"></script>
<script type="text/javascript">
    function getAjax()
    {
        var xmlhttp=null;
