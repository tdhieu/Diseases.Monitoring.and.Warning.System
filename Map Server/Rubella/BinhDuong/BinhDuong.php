...
<script type="text/javascript">
    var b=new Array("644543.053833", "1201573.303240", "714593.546097", "1271877.153095");
    var b0=b[0];
    var b1=b[1];
    var b2=b[2];
    var b3=b[3];
    ...
    var $str0=serverOSGeo4W+'healthgismap/Rubella/BinhDuong/BinhDuong.map';
    var $str1=serverOSGeo4W+'healthgismap/Rubella/BinhDuong/BDcopy.map';

	
</script>
<script src="../OpenLayers/OpenLayers.js"></script>
<script src="BDcopy.js"></script>
<script src="BinhDuong.js"></script>
<script type="text/javascript">
    function getAjax()
    {
        var xmlhttp=null;
