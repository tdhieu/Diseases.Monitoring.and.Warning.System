...
<script type="text/javascript">
    var b=new Array("746817.142941", "1241602.155483", "905739.737087", "1364552.729251");
    var b0=b[0];
    var b1=b[1];
    var b2=b[2];
    var b3=b[3];
    ...
    var $str0=serverOSGeo4W+'healthgismap/Rubella/LamDong/LamDong.map';
    var $str1=serverOSGeo4W+'healthgismap/Rubella/LamDong/LDcopy.map';

	
</script>
<script src="../OpenLayers/OpenLayers.js"></script>
<script src="LDcopy.js"></script>
<script src="LamDong.js"></script>
<script type="text/javascript">
    function getAjax()
    {
        var xmlhttp=null;
