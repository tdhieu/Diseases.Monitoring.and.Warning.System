...
<script type="text/javascript">
    var b=new Array("559482.222413","1022277.048472", "646311.234963", "1098796.003261");
    var b0=b[0];
    var b1=b[1];
    var b2=b[2];
    var b3=b[3];
    ...
    var $str0=serverOSGeo4W+'healthgismap/Rubella/SocTrang/SocTrang.map';
    var $str1=serverOSGeo4W+'healthgismap/Rubella/SocTrang/STcopy.map';

	
</script>
<script src="../OpenLayers/OpenLayers.js"></script>
<script src="STcopy.js"></script>
<script src="SocTrang.js"></script>
<script type="text/javascript">
    function getAjax()
    {
        var xmlhttp=null;
