...
function init()	
{
    ...
    layer1=new OpenLayers.Layer.WMS("Ban do duong di",$str+$str0,{
        layers: 'duong',
        format: 'image/png',
        isBaseLayer:  false,
        transparent: true
    });
    layer2=new OpenLayers.Layer.WMS("Ban do song ho",$str+$str0,{
        layers: 'songho',
        format: 'image/png',
        isBaseLayer:  false,
        transparent: true
    });
    layer3=new OpenLayers.Layer.WMS("Ban do Huyen Dong Nai",$str+$str0,{
        layers: 'hanhchinh',
        format: 'image/png',
        isBaseLayer:  false,
        transparent: true,
    ...
    layer5=new OpenLayers.Layer.WMS("Vung trong diem",$str+$str0,{
        layers: 'symbol',
        format: 'image/gif',
        transparent: true,
        opacity:0.5
    ...
    layer6=new OpenLayers.Layer.WMS("Vung dich benh",$str+$str0,{
        layers: 'huyen',
        format: 'image/gif',
        transparent: true,
        opacity:0.5
    ...
    map.addLayers([layer3,layer2,layer1,layer6,layer5]);
    ...
    map.events.register("click",map,function(evt)
    {
        ...
        var url=getURL_GetFeatureInfo(evt,layer3,theInformat);
        OpenLayers.loadURL(url,'',map,function(response){
            ...
            if(popup_info!="")
            {
                popup=new OpenLayers.Popup.FramedCloud("Thong tin",mouseLoc,new OpenLayers.Size(600,400),
                    //maxSize(800,900),
                    popup_info,
                    null,
                    true
...
<!--Lay tham so doi tuong tren ban do-->
