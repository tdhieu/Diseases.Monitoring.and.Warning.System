...
<script type="text/javascript">
    var b=new Array("365898.155803", "1037756.347706", "559074.143825", "1165376.341027");
    var b0=b[0];
    var b1=b[1];
    var b2=b[2];
    var b3=b[3];
    ...
    var $str0=serverOSGeo4W+'healthgismap/Rubella/KienGiang/KienGiang.map';
    var $str1=serverOSGeo4W+'healthgismap/Rubella/KienGiang/KGcopy.map';

	
</script>
<script src="../OpenLayers/OpenLayers.js"></script>
<script src="KGcopy.js"></script>
<script src="KienGiang.js"></script>
<script type="text/javascript">
    function getAjax()
    {
        var xmlhttp=null;
