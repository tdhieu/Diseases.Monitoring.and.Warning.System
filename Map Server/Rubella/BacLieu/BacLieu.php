...
<script type="text/javascript">
    var b=new Array("525342.142929","996273.821354", "594248.639739", "1065454.039921");
    var b0=b[0];
    var b1=b[1];
    var b2=b[2];
    var b3=b[3];
    ...
    var $str0=serverOSGeo4W+'healthgismap/Rubella/BacLieu/BacLieu.map';
    var $str1=serverOSGeo4W+'healthgismap/Rubella/BacLieu/BLcopy.map';

	
</script>
<script src="../OpenLayers/OpenLayers.js"></script>
<script src="BLcopy.js"></script>
<script src="BacLieu.js"></script>
<script type="text/javascript">
    function getAjax()
    {
        var xmlhttp=null;
