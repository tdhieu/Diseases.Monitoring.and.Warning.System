<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DuLieuDichBenhs.ascx.cs" Inherits="Adicom.Web.admin.Modules.DuLieuDichBenhs" %>
...
<asp:GridView ID="gvNews" runat="server" AutoGenerateColumns="False" Width="100%"
    ...
    <Columns>
       ...
       <asp:BoundField DataField="Dateup" HeaderText="Ngày Cập Nhật" SortExpression="Dateup" />
    </Columns>
    <EmptyDataTemplate>
