<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DanhSachDichBenhHuyen.ascx.cs"
    Inherits="Adicom.Web.admin.Modules.DanhSachDichBenhHuyen" %>
<center>
    <p>
        Danh Sách Dữ Liệu Thống kê giám sát quảng lý dịch bệnh truyền nhiễm theo quận huyện</p>
    <table border="0" cellpadding="0" cellspacing="0" style="margin-bottom: 0px" width="95%">
        <tr>
            <td align="center">
                Từ Ngày&nbsp;
            ...
            <td align="center">
                Huyện
                <asp:DropDownList ID="cbxHuyen" runat="server" Width="150px">
                </asp:DropDownList>
            </td>
            <td align="center">
                Bệnh Dịch
...
<asp:GridView ID="gvNews" runat="server" AllowPaging="True" AutoGenerateColumns="False"
    PageSize="15" Width="100%" OnSelectedIndexChanged="gvNews_SelectedIndexChanged">
    <Columns>
